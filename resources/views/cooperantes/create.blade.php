...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Registro de organización, contactos, teléfonos, sitios web y redes sociales.</p>
        </div>
    ...
    <form action="{{ route('cooperantes.store') }}" method="POST">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-info text-white d-flex justify-content-between">
                <span>3. Teléfonos de la organización</span>
...
function agregarContacto() {
    ...
    <div class="border rounded p-3 mb-3 contacto-item">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <label>Nombre completo</label>
                <input type="text" name="contactos[${contactoIndex}][nombre]" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label>Cargo</label>
                <input type="text" name="contactos[${contactoIndex}][cargo]" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label>Correo</label>
                <input type="email" name="contactos[${contactoIndex}][correo]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>Teléfono</label>
                <input type="text" name="contactos[${contactoIndex}][telefono]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>WhatsApp</label>
                <input type="text" name="contactos[${contactoIndex}][whatsapp]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>Idioma</label>
                <input type="text" name="contactos[${contactoIndex}][idioma]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>Medio preferido</label>
                <input type="text" name="contactos[${contactoIndex}][medio_preferido]" class="form-control">
            </div>
            <div class="col-md-12 mb-3">
                <label>Notas</label>
                <textarea name="contactos[${contactoIndex}][notas]" class="form-control" rows="2"></textarea>
            </div>
        </div>
    </div>`;
...
function agregarTelefono() {
    ...
    <div class="border rounded p-3 mb-3 telefono-item">
        ...
        <div class="row">
            <div class="col-md-3 mb-3">
                <label>Tipo</label>
                <input type="text" name="telefonos[${telefonoIndex}][tipo]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>Número</label>
            ...
            <div class="col-md-2 mb-3">
                <label>País</label>
                <input type="text" name="telefonos[${telefonoIndex}][pais]" class="form-control">
            </div>
            <div class="col-md-2 mb-3">
                <label>Observaciones</label>
                <input type="text" name="telefonos[${telefonoIndex}][observaciones]" class="form-control">
            </div>
        </div>
    </div>`;
...
function agregarWeb() {
    ...
    <div class="border rounded p-3 mb-3 web-item">
        ...
        <div class="row">
            <div class="col-md-3 mb-3">
                <label>Tipo</label>
                <input type="text" name="webs[${webIndex}][tipo]" class="form-control">
            </div>
            <div class="col-md-5 mb-3">
                <label>URL</label>
                <input type="url" name="webs[${webIndex}][url]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>Descripción</label>
                <input type="text" name="webs[${webIndex}][descripcion]" class="form-control">
            </div>
            <div class="col-md-1 mb-3">
                <label>Activo</label>
                <input type="checkbox" name="webs[${webIndex}][activo]" class="form-check-input d-block mt-2" checked>
            </div>
        </div>
    </div>`;
...
function agregarRed() {
    ...
    <div class="border rounded p-3 mb-3 red-item">
        ...
        <div class="row">
            <div class="col-md-3 mb-3">
                <label>Red social</label>
                <input type="text" name="redes[${redIndex}][red_social]" class="form-control">
            </div>
            <div class="col-md-4 mb-3">
                <label>URL</label>
                <input type="url" name="redes[${redIndex}][url]" class="form-control">
            </div>
            <div class="col-md-2 mb-3">
                <label>Usuario</label>
                <input type="text" name="redes[${redIndex}][usuario]" class="form-control">
            </div>
            <div class="col-md-3 mb-3">
                <label>Notas</label>
                <input type="text" name="redes[${redIndex}][notas]" class="form-control">
            </div>
        </div>
    </div>`;
