...
<div class="container py-4">
  ...
  <div class="card shadow-sm border-0">
    ...
    <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between">
      <h5 class="mb-0">
        Detalle Donación #{{ $donacion->id_donacion }}
      </h5>
    ...
    <div class="card-body">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-3">
          <div class="text-muted small">Fecha despachada</div>
        ...
        <div class="col-md-3">
          <div class="text-muted small">Valor total donación</div>
          <div class="fw-semibold">
            Q {{ number_format(
                (float) ($donacion->valor_total_donacion ?? 0),
                2,
                '.',
                ','
            ) }}
        ...
        <div class="col-md-3">
          <div class="text-muted small">Fecha que recibe</div>
          <div class="fw-semibold">
            {{ $donacion->fecha_recibe
                ? \Carbon\Carbon::parse($donacion->fecha_recibe)->format('d/m/Y')
                : '—'
            }}
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="text-muted small">Quién recibe</div>
          <div class="fw-semibold">
            {{ $donacion->quien_recibe ?? '—' }}
          </div>
        </div>
        ...
        <div class="col-md-2">
          <div class="text-muted small">Unidades entrega</div>
          <div class="fw-semibold">
            {{ $donacion->unidades_entrega ?? 0 }}
          </div>
        </div>

        <div class="col-md-4">
          <div class="text-muted small">Persona que gestionó</div>
          <div class="fw-semibold">
        ...
        <div class="col-md-3">
          ...
          <div class="fw-semibold">
            Q {{ number_format(
                (float) ($donacion->costo_logistica ?? 0),
                2,
                '.',
                ','
            ) }}
        ...
        <div class="col-md-12">
          ...
          <div class="fw-semibold">
            {{ $donacion->descripcion_logistica ?? '—' }}
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="text-muted small">Impacto (personas)</div>
          <div class="fw-semibold">
            {{ number_format(
                (int) ($donacion->impacto_personas ?? 0)
            ) }}
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-muted small">Recibo de empresa</div>

          <div class="fw-semibold">
            @php
              $re = $donacion->recibo_empresa;
            @endphp
        ...
        <div class="col-md-6">
          <div class="text-muted small">No. Referencia OSSHP</div>
          <div class="fw-semibold">
            {{ $donacion->ref_osshp ?? '—' }}
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="text-muted small">Fecha referencia OSSHP</div>
          <div class="fw-semibold">
            {{ $donacion->fecha_ref_osshp
                ? \Carbon\Carbon::parse($donacion->fecha_ref_osshp)->format('d/m/Y')
                : '—'
            }}
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="text-muted small">No. Referencia SAT</div>
          <div class="fw-semibold">
            {{ $donacion->ref_sat ?? '—' }}
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="text-muted small">Fecha referencia SAT</div>
          <div class="fw-semibold">
            {{ $donacion->fecha_ref_sat
                ? \Carbon\Carbon::parse($donacion->fecha_ref_sat)->format('d/m/Y')
                : '—'
            }}
          </div>
        </div>
